...
Future upstatus(String id) async {
 ...
 Future achetermilesQ(String id, String solde) async {
    var Url = "http://10.0.2.2:8081/achatmilesq";
    var res = await http.post(Uri.parse(Url),
        headers: {"Content-Type": "application/json"},
...
class PaymentMilesQ extends StatefulWidget {


  String price = '';
  String miles = '';

  PaymentMilesQ(String price, String miles) {
    price1 = price;
    miles1 = miles;
  }

  @override
  State<PaymentMilesQ> createState() => _PaymentMilesQState();
}

class _PaymentMilesQState extends State<PaymentMilesQ> {
